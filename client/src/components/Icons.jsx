...
function createSvgIcon(svgContent) {
  return function Icon({ size = 20, color = 'currentColor', className = '', style = {}, ...props }) {
    return (
      <svg
        width={size}
        height={size}
...
export const Stethoscope = createSvgIcon(
  <>
...
export const HeartPulse = createSvgIcon(
  <>
...
export const Baby = createSvgIcon(
  <>
    <circle cx="12" cy="12" r="10" />
...
export const MessageSquare = createSvgIcon(
...
export const DollarSign = createSvgIcon(
  <>
...
export const CalendarCheck = createSvgIcon(
  <>
    <rect x="3" y="4" width="18" height="18" rx="2" ry="2" />
    <line x1="16" y1="2" x2="16" y2="6" />
    <line x1="8" y1="2" x2="8" y2="6" />
...
export const Award = createSvgIcon(
  <>
